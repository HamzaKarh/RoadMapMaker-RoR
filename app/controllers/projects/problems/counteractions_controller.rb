class Projects::Problems::CounteractionsController < ApplicationController
    before_counteraction :get_problem
    before_counteraction :set_counteraction, only: [:show, :edit, :update, :destroy]
    ...
    def create
      @counteraction =  @problem.actions.build(counteraction_params)
      respond_to do |format|  
        if @counteraction.save
          format.html { redirect_to @problem, notice: 'counteraction was successfully created.' }
